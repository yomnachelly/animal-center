    ...
    <div class="admin-dashboard">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card primary">
                ...
                <div class="stat-number">{{ $stats['especes_count'] }}</div>
            ...
            <div class="stat-card success">
                ...
                <div class="stat-number">{{ $stats['animaux_count'] }}</div>
                <div class="stat-label">Animaux au Refuge</div>
                <div class="stat-trend">
                    <i class="fas fa-home me-1"></i>
                    {{ $stats['animaux_adoptables'] }} adoptables
                </div>
            </div>
            ...
            <div class="stat-card warning">
                ...
                <div class="stat-number">{{ $stats['races_count'] }}</div>
            ...
            <div class="stat-card purple">
                ...
                <div class="stat-number">{{ $stats['demandes_total'] }}</div>
                <div class="stat-label">Demandes Total</div>
                <div class="stat-trend">
                    <i class="fas fa-chart-line me-1"></i>
                    {{ $stats['demandes_acceptees'] }} acceptées
                </div>
            </div>
            ...
            <div class="stat-card orange">
                ...
                <div class="stat-number">{{ $stats['avis_count'] }}</div>
        ...
        <div class="charts-section">
            ...
            <div class="chart-card">
                ...
                <div class="mini-stats">
                    <div class="mini-stat attente">
                        <div class="mini-stat-number">{{ $stats['demandes_attente'] }}</div>
                        <div class="mini-stat-label">En Attente</div>
                    </div>
                    <div class="mini-stat accepte">
                        <div class="mini-stat-number">{{ $stats['demandes_acceptees'] }}</div>
                        <div class="mini-stat-label">Acceptées</div>
                    </div>
                    <div class="mini-stat refuse">
                        <div class="mini-stat-number">{{ $stats['demandes_refusees'] }}</div>
            ...
            <div class="chart-card">
                ...
                <div class="mini-stats">
                    <div class="mini-stat attente">
                        <div class="mini-stat-number">{{ $stats['rdv_attente'] }}</div>
                        <div class="mini-stat-label">En Attente</div>
                    </div>
                    <div class="mini-stat accepte">
                        <div class="mini-stat-number">{{ $stats['rdv_acceptes'] }}</div>
                        <div class="mini-stat-label">Acceptés</div>
                    </div>
                    <div class="mini-stat refuse">
                        <div class="mini-stat-number">{{ $stats['rdv_refuses'] }}</div>
        ...
        <div class="quick-actions">
            ...
            <div class="actions-grid">
                <a href="{{ route('animaux.index') }}" class="action-btn">
